...
import { IBuyerDocument, ISellerDocument, winstonLogger } from '@19010853/ithust-shared';
...
const consumeBuyerDirectMessage = async (channel: Channel): Promise<void> => {
    try {
        ...
        const exchangeName = 'ithust-buyer-update';
        ...
        await channel.bindQueue(ithustQueue.queue, exchangeName, routingKey);
...
const consumeSellerDirectMessage = async (channel: Channel): Promise<void> => {
    try {
        ...
        const exchangeName = 'ithust-seller-update';
