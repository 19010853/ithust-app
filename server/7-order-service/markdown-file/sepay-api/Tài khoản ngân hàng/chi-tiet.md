...
## Lấy thông tin chi tiết một tài khoản ngân hàng theo UUID qua SePay API v2. Trả về số tài khoản, ngân hàng, trạng thái và thông tin cấu hình.
...
<Endpoint>
  ...
  <Path>https://userapi.sepay.vn/v2/bank-accounts/{xid}</Path>
...
Lấy thông tin chi tiết một tài khoản ngân hàng theo UUID.

### Tham số

<Params>
  <PathParams>
    <Param name="xid" type="string" required="true">
...
<CodeSamples>
  ...
  <CodeSample value="php_curl" lang="php">
    ...
    curl_setopt_array($curl, [
      CURLOPT_URL => "https://userapi.sepay.vn/v2/bank-accounts/f9e8d7c6-b5a4-3210-fedc-ba0987654321",
  ...
  <CodeSample value="python_python3" lang="python">
    ...
    conn.request("GET", "/v2/bank-accounts/f9e8d7c6-b5a4-3210-fedc-ba0987654321", headers=headers)
  ...
  <CodeSample value="node_native" lang="javascript">
    ...
    const options = {
      ...
      "port": null,
      "path": "/v2/bank-accounts/f9e8d7c6-b5a4-3210-fedc-ba0987654321",
      "headers": {
        "Authorization": "Bearer REPLACE_BEARER_TOKEN"
      }
    };
  ...
  <CodeSample value="ruby_native" lang="ruby">
    ...
    url = URI("https://userapi.sepay.vn/v2/bank-accounts/f9e8d7c6-b5a4-3210-fedc-ba0987654321")
  ...
  <CodeSample value="csharp_httpclient" lang="csharp">
    ...
    var request = new HttpRequestMessage
    {
        ...
        RequestUri = new Uri("https://userapi.sepay.vn/v2/bank-accounts/f9e8d7c6-b5a4-3210-fedc-ba0987654321"),
        Headers =
        {
            { "Authorization", "Bearer REPLACE_BEARER_TOKEN" },
        },
  ...
  <CodeSample value="swift_nsurlsession" lang="swift">
    ...
    let request = NSMutableURLRequest(url: NSURL(string: "https://userapi.sepay.vn/v2/bank-accounts/f9e8d7c6-b5a4-3210-fedc-ba0987654321")! as URL,
...
"data": {
  ...
  "account_holder_name": "CONG TY TNHH PHAT DAT",
  "account_number": "68720198345",
  "accumulated": 8750000,
  "last_transaction": "2026-02-27 08:15:00",
...
* **404**: Trả 404 nếu tài khoản không tìm thấy hoặc không thuộc công ty đã xác thực
