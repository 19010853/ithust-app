    ...
    <div className="relative m-auto mt-8 w-screen px-6 xl:container md:px-12 lg:px-6">
      <div className="mx-auto flex flex-col px-4 py-8 lg:px-6 lg:py-10">
        <div className="flex flex-col text-left">
          <h2 className="mb-3 text-3xl font-bold text-black">Nhiều lựa chọn dịch vụ</h2>
          <h4>Chọn từ nhiều dịch vụ của các freelancer chuyên nghiệp cho dự án tiếp theo của bạn.</h4>
        </div>
        <div className="mt-6">
        ...
        <div className="mt-4 h-full overflow-hidden border px-6 py-6">
          {categoryGigs.length > 0 ? (
            ...
            <div className="flex h-96 items-center justify-center text-lg">Hiện chưa có thông tin.</div>
          )}
        </div>
      </div>
    </div>
