  ...
  return (
    <div className="mx-auto my-8 flex flex-col w-full">
      <div className="flex w-full flex-col justify-between self-center">
        <h2 className="flex self-center text-base font-bold md:text-2xl lg:text-3xl">Chuyên gia nổi bật</h2>
        <h4 className="pt-1 text-center text-sm md:text-base lg:text-lg">Làm việc cùng những người tài năng để đạt kết quả tốt nhất.</h4>
      </div>
      <div className="mt-6">
          ...
          {sellers.map((seller: ISellerDocument) => (
            <div key={uuidv4()} className="w-full rounded-lg border border-grey bg-white shadow">
              <div className="flex flex-col items-center pb-10 pt-5">
                <img className="mb-3 h-24 w-24 rounded-full shadow-lg" src={seller.profilePicture} alt="Ảnh đại diện" />
