...
import { lowerCase, orderStatusDisplayLabel } from 'src/shared/utils/utils.service';
  ...
  return (
    <div className="border-grey z-20 flex max-h-[470px] flex-col justify-between rounded border bg-white shadow-md">
      <div className="h-96 overflow-y-scroll">
        ...
        {orders.length === 0 && <div className="flex h-full items-center justify-center">Không có đơn hàng để hiển thị</div>}
      </div>
      {orders.length > 0 && (
        <Link
